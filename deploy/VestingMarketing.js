module.exports = async function ({ ethers, getNamedAccounts, deployments, hre }) {
  ...
  const vestDuration = 84 * month;
  const vestInterval = month;
  const receiver = "0xF99fd1A6aBecc01B421464Cf5717e26402B8f22e";
  const amount = parseEther("138621466");
...
module.exports.tags = ["VestingMarketing"];
