...
describe("TokenVesting", function () {
  ...
  describe("Behavior after cliff", function () {
    this.beforeEach(async function () {
      ...
      this.expectedReleasableAmount = calculateReleasableAmount(this.start, this.currentTime, this.interval, this.duration, this.amount);
    });
  ...
  describe("Behavior on creating new vesting", function () {
    describe("Reverts", function () {
      ...
      it("when interval is 0", async function () {
        const creation = this.vesting.createVesting(this.dummyBeneficiaryAddress, this.start, this.cliff, 0, this.duration, this.amount);
      ...
      it("when vesting already exists", async function () {
        ...
        await this.vesting
          .connect(this.dummyBeneficiary)
          .createVesting(this.dummyBeneficiaryAddress, this.start, this.cliff, this.interval, this.duration, 1);
        const dummyCreation = this.vesting
          .connect(this.dummyBeneficiary)
          .createVesting(this.dummyBeneficiaryAddress, this.start, this.cliff, this.interval, this.duration, 1);
